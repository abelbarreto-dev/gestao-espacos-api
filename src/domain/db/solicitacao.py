...
class Solicitacao(Base):
    ...
    id_solicitante: Mapped[int] = mapped_column(nullable=False)
    id_usuario: Mapped[int] = mapped_column(nullable=False)
    id_espaco: Mapped[int] = mapped_column(nullable=False)
    id_tipo_evento: Mapped[int] = mapped_column(nullable=False)
